...
//We've stored all the RE-USABLE METHODS of selenium. 
//eg:- WebDriver Interface Methods, JavaScriptExecutor Interface Methods, Action Class, Select Class, Robot Class, WebDriverWait Class, Alert interface mrthods etc.
