...
public class ActitimeNewCustomerPage extends BasePage implements AutoConstant
{
	...
	public void createCustomerMethod(String customerName) throws InterruptedException, IOException 
	{
		...
		enterCustomerNameTextfield.sendKeys(ExcelLibrary.getcellvalue(sheet_name_customer, 0, 0));
